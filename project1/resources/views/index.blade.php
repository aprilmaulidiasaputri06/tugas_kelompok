...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="{{ asset('styles/images/favicon.png') }}" type="image/png">
        
    <!--====== Magnific Popup CSS ======-->
    <link rel="stylesheet" href="{{ asset('styles/css/magnific-popup.cs') }}">
        
    <!--====== Slick CSS ======-->
    <link rel="stylesheet" href="{{ asset('styles/css/slick.css') }}">
        
    <!--====== Line Icons CSS ======-->
    <link rel="stylesheet" href="{{ asset('styles/css/LineIcons.css') }}">
        
    <!--====== Bootstrap CSS ======-->
    <link rel="stylesheet" href="{{ asset('styles/css/bootstrap.min.css') }}">
    
    <!--====== Default CSS ======-->
    <link rel="stylesheet" href="{{ asset('styles/css/default.css') }}">
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <a class="navbar-brand" href="#">
                            <img src="{{ asset('styles/images/logo.svg') }}" alt="Logo">
                        </a>
        ...
        <div id="carouselThree" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="{{ asset('styles/images/slider/1.png') }}" alt="Hero">
                        </div> <!-- slider-imgae -->
                ...
                <div class="carousel-item">
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="{{ asset('styles/images/slider/2.png') }}" alt="Hero">
                        </div> <!-- slider-imgae -->
                    </div> <!-- slider-imgae box -->
                </div> <!-- carousel-item -->
                ...
                <div class="carousel-item">
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="{{ asset('styles/images/slider/3.png') }}" alt="Hero">
                        </div> <!-- slider-imgae -->
                    </div> <!-- slider-imgae box -->
                </div> <!-- carousel-item -->
            </div>
                    ...
                    <div class="single-features mt-40">
                        <div class="features-title-icon d-flex justify-content-between">
                            ...
                            <div class="features-icon">
                                ...
                                <img class="shape" src="{{ asset('styles/images/f-shape-1.svg') }}" alt="Shape">
                            </div>
                        </div>
                ...
                <div class="col-lg-9 col-md-9">
                    <div class="row no-gutters grid mt-50">
                        <div class="col-lg-4 col-sm-6 branding-4 planning-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="{{ asset('styles/images/portfolio/1.png') }}" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="{{ asset('style/images/portfolio/1.png') }}"><i class="lni lni-zoom-in"></i></a>
                                                <img src="{{ asset ('style/images/portfolio/shape.svg') }}" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                            ...
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    ...
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href=""><i class="lni lni-zoom-in"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 branding-4 marketing-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="{{ asset('style/images/portfolio/2.png') }}" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="{{ asset('style/images/portfolio/2.png') }}"><i class="lni lni-zoom-in"></i></a>
                                                <img src="{{ asset('style/images/portfolio/shape.svg') }}" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                                                <img src="{{ asset('styles/images/portfolio/shape.svg') }}" alt="shape" class="shape">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-6 planning-4 research-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="{{ asset('styles/images/portfolio/4.png') }}" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="{{ asset('styles/images/portfolio/4.png') }}"><i class="lni lni-zoom-in"></i></a>
                                                <img src="{{ asset('styles/images/portfolio/shape.svg') }}" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
...
-->
    ...
    <script src="{{ asset('styles/js/vendor/modernizr-3.7.1.min.j') }}s"></script>
    ...
    <!--====== Ajax Contact js ======-->
    <script src="{{ asset('styles/js/ajax-contact.js') }}"></script>
